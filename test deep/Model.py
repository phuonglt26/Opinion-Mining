...
DOMAIN_TRAIN = {
    'tech_tiki': 'giá,dịch_vụ,ship,hiệu_năng,chính_hãng,cấu_hình,phụ_kiện,mẫu_mã'
}
...
def model(domain,label):
    ...
    history = model.fit(xtrain, y_train, batch_size=128, epochs=20, verbose=1, validation_split=0.2)
